...
- remove command tokens
    - Each player removes all of his command tokens from the game board and returns them to his reinforcements.
- gain and redistribute command tokens
    - Each player gains two command tokens from his reinforcements.
    - Then, he may redistribute any of the command tokens on his command sheet
- ready cards
- repair units
    - Players repair units during this step by turning them upright
- return strategy cards
    - Each player returns his strategy card to the common play area
